...
setup(
    ...
    package_dir={
        "statick_tool": ".",
        "statick_tool.plugins.discovery": "src/statick_tooling/plugins/discovery",
        "statick_tool.plugins.tool": "src/statick_tooling/plugins/tool",
    },
    package_data={
    ...
    url="https://github.com/sscpac/statick-tooling",
    classifiers=[
